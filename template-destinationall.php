...
foreach ($post_types_to_loop_through as $post_type_item => $post_type_item_nice_name) {
     ...
     <div class="listings <?php /*if ($section_counter > 0) { echo 'bordertop'; }*/ ?>">
         <h2 class="cufon"><?php printf( __( 'Hotels in...', 'woothemes' ), $post_type_item_nice_name['nice_name'] ); ?></h2>
          ...
          foreach ( $all_terms as $all_term) {
               ...
               if ( ($tax_test == 'true') && ($block_counter <= 1000) ) {
         ...
         <div class="fix"></div>
          ...
          ?>
          <h3 class="banner"><a href="http://essentialworld.travel/all-destinations/" title="<?php printf( __( 'View all hotels in...', 'woothemes' ), $post_type_item_nice_name['nice_name'] ); ?>"><?php printf( __( 'View all hotels in...', 'woothemes' ), $post_type_item_nice_name['nice_name'] ); ?></a></h3>
