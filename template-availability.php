...
if ( $children == 0 AND $adults < 3 ) {
  ...
  if ( is_object( $obj ) ) {
    ...
    foreach ( $obj->lr_rates->hotel->hotel_rooms->room as $rm ) {
      ...
      $out .= '<tr><td width="200px" class="rmdes" style="font-weight:bold;">';
      ...
      foreach ( $rm->rate as $rt ) {
        ...
        $out .= '<td width="1px" width:"50px" class="price"> ' . (string) $rt->price . '</td><td class="totalpr" align="right" style="font-weight:bold;">';
