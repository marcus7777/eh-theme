...
foreach ($post_types_to_loop_through as $post_type_item => $post_type_item_nice_name) {
	...
	<div class="listings <?php /*if ($section_counter > 0) { echo 'bordertop'; }*/ ?>">
		...
		?>
		<h3 class="banner"><a href="http://essentialworld.travel/all-collections/" title="<?php printf( __( 'View all hotels by collections', 'woothemes' ), $post_type_item_nice_name['nice_name'] ); ?>"><?php printf( __( 'View hotels by collections', 'woothemes' ), $post_type_item_nice_name['nice_name'] ); ?></a></h3>
